...
public class ComprarProdutoSteps {
	...
	public static void inicializar() {
		...
		// Método de espera implicita. Dessa forma sera implementada para todos os
		// findElement(s).
	...
	public void adiciono_o_produto_no_carrinho_com_tamanho_cor_e_quantidade(String tamanhoProduto, String corProduto,
		...
		assertThat(Funcoes.removeCaracterEspecial(modalProdutoPage.obterMensagemProdutoAdicionado()),
	...
	public void o_produto_aparece_na_confirmacao_com_nome_preco_tamanho_cor_e_quantidade(String nomeProduto,
		...
		Double subtotalCalculado = quantidadeProduto * precoProdutoDoubleEsperado;

		assertThat(subtotalEncontrado, is(subtotalCalculado));
	}
